    ...
    <nav class="site-navbar navbar  navbar-fixed-top navbar-mega" role="navigation">
      ...
      <ul class="site-menu">
        <li class="site-menu-item has-sub">
          <a href="javascript:;">
                  ...
                  <span class="site-menu-title">Agendar Medico</span>
                          <span class="site-menu-arrow"></span>
              </a>
          <ul class="site-menu-sub">
            <li class="site-menu-item">
              <a class="animsition-link" href="<?=base_url('index.php/agendarmedico');?>">
                <span class="site-menu-title">Primera vez</span>
              </a>
            </li>                        
          </ul>
        </li>                                          
          ...
          <ul class="site-menu-sub">
            <li class="site-menu-item">
              <a class="animsition-link" href="<?=base_url('index.php/preregistro');?>">
                <span class="site-menu-title">Pre-registro</span>
              </a>
            </li>            
            <!--
            <li class="site-menu-item has-sub">
          ...
          <ul class="site-menu-sub">            
            <li class="site-menu-item">
              <a class="animsition-link" href="">
                <span class="site-menu-title">Recepcion</span>
              </a>
            </li>            
          </ul>
        </li>        
      ...
      <div>
        <div>
          <ul>
          <li>
              <a href="<?=base_url('index.php//homeR');?>">
