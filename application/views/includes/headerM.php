    ...
    <nav class="site-navbar navbar  navbar-fixed-top navbar-mega" role="navigation">
      ...
      <ul class="site-menu">
        <li class="site-menu-item has-sub">
          ...
          <ul class="site-menu-sub">
            <li class="site-menu-item">
              <a class="animsition-link" href="<?=base_url('index.php/');?>">
                <span class="site-menu-title">Atender</span>
              </a>
            </li> 
            <li class="site-menu-item">
              <a class="animsition-link" href="<?=base_url('index.php/');?>">
                <span class="site-menu-title">Agendar</span>
              </a>
            </li>                       
          </ul>
        </li>                                          
        <li class="site-menu-item has-sub">
          <a href="javascript:void(0)">
                  ...
                  <span class="site-menu-title">Expedientes Clinicos</span>
                          <span class="site-menu-arrow"></span>
              </a>
          <ul class="site-menu-sub">
            <li class="site-menu-item">
              <a class="animsition-link" href="<?=base_url('index.php/preregistro');?>">
                <span class="site-menu-title">Generar</span>
              </a>
            </li>            
            <!--
            <li class="site-menu-item has-sub">
        ...
        <li class="site-menu-item has-sub">
          <a href="javascript:void(0)">
                  ...
                  <span class="site-menu-title">Fechas</span>
                          <span class="site-menu-arrow"></span>
              </a>
          <ul class="site-menu-sub">            
            <li class="site-menu-item">
              <a class="animsition-link" href="">
                <span class="site-menu-title">No atencion</span>
              </a>
            </li>            
          </ul>
        </li>        
      ...
      <div>
        <div>
          <ul>
          <li>
              <a href="<?=base_url('index.php//homeM');?>">
